...
public class slingu2lab6b
{
  ...
  while ( x < width )
  {
    ...
    while ( y < height)
    {
      ...
      redAmount=(int)(redAmount * 0.299 + greenAmount *.587 + blueAmount *0.114);
      blueAmount=(int)(redAmount * 0.299 + greenAmount *.587 + blueAmount *0.114);
